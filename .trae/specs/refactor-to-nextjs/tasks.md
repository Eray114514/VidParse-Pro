# Tasks
- [x] Task 1: Clean up existing Vite project and initialize Next.js App Router project with Tailwind CSS.
- [x] Task 2: Install and configure modern UI libraries (shadcn/ui, Framer Motion, Lucide React).
- [x] Task 3: Setup Next.js API Routes for Bilibili parsing (Official API -> Cobalt -> Fallback) capped at 1080P (qn=80).
- [x] Task 4: Setup Python Serverless function (`api/yt.py`) and `requirements.txt` for `yt-dlp` fallback.
